...
export class ShadowLogger {
    ...
    getStats() {
        ...
        for (const stored of this.entries) {
            ...
            if (!stored.encrypted && 'level' in stored.data) {
    ...
    shredEntry(entry) {
        ...
        else if ('ciphertext' in entry.data) {
