...
export class SoftSignalPro {
    ...
    getToneScore(text) {
        ...
        for (const word of words) {
            ...
            else if (NEGATIVE_WORDS.includes(lower)) {
                negative++;
            }
            else {
                neutral++;
    ...
    calculateConfidence(score, markers) {
